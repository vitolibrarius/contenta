...
/** Sample Creation script */
		...
		$sql = "CREATE TABLE IF NOT EXISTS users ( "
			. model\user\Users::id . " INTEGER PRIMARY KEY, "
			. model\user\Users::name . " TEXT, "
			. model\user\Users::email . " TEXT, "
			. model\user\Users::active . " INTEGER, "
			. model\user\Users::account_type . " TEXT, "
			. model\user\Users::rememberme_token . " TEXT, "
			. model\user\Users::api_hash . " TEXT, "
			. model\user\Users::password_reset_hash . " TEXT, "
			. model\user\Users::activation_hash . " TEXT, "
			. model\user\Users::failed_logins . " INTEGER, "
			. model\user\Users::creation_timestamp . " INTEGER, "
			. model\user\Users::last_login_timestamp . " INTEGER, "
			. model\user\Users::last_failed_login . " INTEGER, "
			. model\user\Users::password_reset_timestamp . " INTEGER, "
			. ")";
