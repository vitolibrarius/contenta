...
abstract class _Story_Arc_Publication extends Model
{
	...
	{
		return array(
			Story_Arc_Publication::story_arc => array(
			...
			Story_Arc_Publication::publication => array(
	...
	public function searchQualifiers( array $query )
	{
		...
		if ( is_array($query) ) {
			foreach( $query as $attr => $value ) {
				switch ($attr) {
			// Story_Arc_Publication::id == INTEGER

			// Story_Arc_Publication::story_arc_id == INTEGER
				case Story_Arc_Publication::story_arc_id:
					if ( intval($value) > 0 ) {
						$qualifiers[Story_Arc_Publication::story_arc_id] = Qualifier::Equals( Story_Arc_Publication::story_arc_id, intval($value) );
					}
					break;
			...
			// Story_Arc_Publication::publication_id == INTEGER
				case Story_Arc_Publication::publication_id:
					if ( intval($value) > 0 ) {
						$qualifiers[Story_Arc_Publication::publication_id] = Qualifier::Equals( Story_Arc_Publication::publication_id, intval($value) );
					}
					break;

				default:
					/* no type specified for Story_Arc_Publication::publication_id */
					break;
				}
			}
		}
