...
/*
		...
		$sql = 'CREATE UNIQUE INDEX IF NOT EXISTS series_alias_character_idname on series_alias (character_id,name)';
		$this->sqlite_execute( "series_alias", $sql, "Index on series_alias (character_id,name)" );
*/
