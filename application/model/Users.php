...
class Users extends Model
{
	...
	public function login()
	{
		...
		$user = $this->userByName($_POST['user_name']);
		if ( $user == false )
		{
		...
		$_SESSION["feedback_positive"][] = 'Found user ' . $user->name . ' pass <pre>' . $user->password_hash . '</pre>';
		...
		if ( PHP_VERSION_ID > 50500 )
		{
			...
			$_SESSION["feedback_positive"][] = 'pass <pre>' . $password_hash . '</pre>';
