...
{
	public function targetVersion() { return "0.8.1"; }
	...
	public function sqlite_upgrade()
	{
		...
		if ( isset($table_fields[ Endpoint::daily_max ]) == false ) {
			$this->sqlite_execute(
				Endpoint::TABLE ,
				"ALTER TABLE " . Endpoint::TABLE . " ADD COLUMN " . Endpoint::daily_max . " INTEGER",
				"Adding the Endpoint::daily_max column"
			);
		}
